...
//--------------------------------------------------------------
   public String doTrans()      // do translation to postfix
      ...
      for(int j=0; j<input.length(); j++)      // for each char
         ...
         theStack.displayStack("Untuk "+ch+" "); // *diagnostic*
         switch(ch)
            {
            case '+':               // it's + or -
            case '-':
      ...
      while( !theStack.isEmpty() )     // pop remaining opers
         {
         theStack.displayStack("Sewaktu ");  // *diagnostic*
         output = output + theStack.pop(); // write to output
         }
      theStack.displayStack("Akhir   ");     // *diagnostic*
...
class infixPostfix
   ...
   public static void main(String[] args) throws IOException
      ...
      while(true)
         ...
         System.out.println("Nilai Postfix = " + output + '\n');
         }  // end while
      }  // end main()
//--------------------------------------------------------------
